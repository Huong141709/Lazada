...
class Lazada extends Component {
  constructor(props) {
    ...
    this.state = {
      products: [],
      fileUpload: null, // Thêm thuộc tính fileUpload vào state
    };
  ...
  async componentDidMount() {
    await axios
      .get("http://localhost:8000/api/get-productLazada")
      .then((res) => {
    ...
    },
    {
      ...
      cell: (row) => (
        <img
          ...
          src={`http://127.0.0.1:8000/source/image/product/${row.Image}`}
          alt="preview"
          style={{ width: "100px" }}
        />
      ),
